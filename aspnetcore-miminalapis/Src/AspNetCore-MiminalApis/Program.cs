...
static async Task<IResult> CreateTodo(TodoItemDTO todoItemDTO, ApplicationDbContext db)
{
...
static async Task<IResult> UpdateTodo(int id, TodoItemDTO todoItemDTO, ApplicationDbContext db)
{
